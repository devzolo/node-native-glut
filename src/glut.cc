 ...
 */
  ...
  void m_keyboardFunc(unsigned char key, int x, int y)
  {
    ...
    {
      m_keyboardFuncCBRef.Call({Napi::String::New(m_keyboardFuncCBRef.Env(), (char *)&key),
  ...
  void m_specialFunc(int key, int x, int y)
  {
    ...
    {
      m_specialFuncCBRef.Call({Napi::Number::New(m_specialFuncCBRef.Env(), key),
  ...
  void m_reshapeFunc(int width, int height)
  {
    ...
    {
      m_reshapeFuncCBRef.Call({Napi::Number::New(m_reshapeFuncCBRef.Env(), width),
  ...
  void m_visibilityFunc(int state)
  {
    ...
    {
      m_visibilityFuncCBRef.Call({Napi::Number::New(m_visibilityFuncCBRef.Env(), state)});
    }
  }
  ...
  void m_mouseFunc(int button, int state, int x, int y)
  {
    ...
    {
      m_mouseFuncCBRef.Call({Napi::Number::New(m_mouseFuncCBRef.Env(), button),
  ...
  void m_motionFunc(int x, int y)
  {
    ...
    {
      m_motionFuncCBRef.Call({Napi::Number::New(m_motionFuncCBRef.Env(), x),
  ...
  void m_passiveMotionFunc(int x, int y)
  {
    ...
    {
      m_passiveMotionFuncCBRef.Call({Napi::Number::New(m_passiveMotionFuncCBRef.Env(), x),
  ...
  void m_entryFunc(int state)
  {
    ...
    {
      m_entryFuncCBRef.Call({Napi::Number::New(m_entryFuncCBRef.Env(), state)});
    }
  }
  ...
  void m_keyboardUpFunc(unsigned char key, int x, int y)
  {
    ...
    {
      m_keyboardUpFuncCBRef.Call({Napi::Number::New(m_keyboardUpFuncCBRef.Env(), key),
  ...
  void m_specialUpFunc(int key, int x, int y)
  {
    ...
    {
      m_specialUpFuncCBRef.Call({Napi::Number::New(m_specialUpFuncCBRef.Env(), key),
  ...
  void m_joystickFunc(unsigned int buttonMask, int x, int y, int z)
  {
    ...
    {
      m_joystickFuncCBRef.Call({Napi::Number::New(m_joystickFuncCBRef.Env(), buttonMask),
  ...
  void m_menuStateFunc(int status)
  {
    ...
    {
      m_menuStateFuncCBRef.Call({Napi::Number::New(m_menuStateFuncCBRef.Env(), status)});
    }
  }
  ...
  void m_menuStatusFunc(int status, int x, int y)
  {
    ...
    {
      m_menuStatusFuncCBRef.Call({Napi::Number::New(m_menuStatusFuncCBRef.Env(), status),
  ...
  void m_windowStatusFunc(int state)
  {
    ...
    {
      m_windowStatusFuncCBRef.Call({Napi::Number::New(m_windowStatusFuncCBRef.Env(), state)});
    }
  }
  ...
  void m_spaceballMotionFunc(int x, int y, int z)
  {
    ...
    {
      m_spaceballMotionFuncCBRef.Call({Napi::Number::New(m_spaceballMotionFuncCBRef.Env(), x),
  ...
  void m_spaceballRotateFunc(int x, int y, int z)
  {
    ...
    {
      m_spaceballRotateFuncCBRef.Call({Napi::Number::New(m_spaceballRotateFuncCBRef.Env(), x),
  ...
  void m_spaceballButtonFunc(int button, int state)
  {
    ...
    {
      m_spaceballButtonFuncCBRef.Call({Napi::Number::New(m_spaceballButtonFuncCBRef.Env(), button),
  ...
  void m_buttonBoxFunc(int button, int state)
  {
    ...
    {
      m_buttonBoxFuncCBRef.Call({Napi::Number::New(m_buttonBoxFuncCBRef.Env(), button),
  ...
  void m_dialsFunc(int dial, int value)
  {
    ...
    {
      m_dialsFuncCBRef.Call({Napi::Number::New(m_dialsFuncCBRef.Env(), dial),
  ...
  void m_tabletMotionFunc(int x, int y)
  {
    ...
    {
      m_tabletMotionFuncCBRef.Call({Napi::Number::New(m_tabletMotionFuncCBRef.Env(), x),
  ...
  void m_tabletButtonFunc(int button, int state, int x, int y)
  {
    if (!m_tabletMotionFuncCBRef.IsEmpty())
    {
      m_tabletMotionFuncCBRef.Call({Napi::Number::New(m_tabletMotionFuncCBRef.Env(), button),
