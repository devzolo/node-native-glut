declare module "@devzolo/node-native-glut" {
	export namespace GLUT {
		...
		function keyboardFunc(
			cb: (key: string, x: number, y: number) => void,
		): void;
		...
		function mouseFunc(
			cb: (button: number, state: number, x: number, y: number) => void,
		): void;
		...
		function keyboardUpFunc(
			cb: (key: string, x: number, y: number) => void,
		): void;
		function specialUpFunc(
			cb: (key: number, x: number, y: number) => void,
		): void;
		function joystickFunc(
			cb: (buttonMask: number, x: number, y: number, z: number) => void,
			pollInterval: number,
		): void;
		function menuStateFunc(cb: (status: number) => void): void;
		function menuStatusFunc(
			cb: (status: number, x: number, y: number) => void,
		): void;
		function overlayDisplayFunc(cb: () => void): void;
		function windowStatusFunc(cb: (state: number) => void): void;

		function spaceballMotionFunc(
			cb: (x: number, y: number, z: number) => void,
		): void;
		function spaceballRotateFunc(
			cb: (x: number, y: number, z: number) => void,
		): void;
		function spaceballButtonFunc(
			cb: (button: number, state: number) => void,
		): void;
